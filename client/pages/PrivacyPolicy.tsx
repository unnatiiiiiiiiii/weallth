              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p>
                    ...
                    protect your personal information when you use our wealth
                    management and financial planning application ("Service").
                    We are committed to protecting your privacy and ensuring the
                    security of your personal and financial data.
                  </p>
                  <p>
                ...
                <section>
                  ...
                  <h3 className="text-xl font-semibold mb-3 text-wealth-purple">
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    ...
                    <li>
                      Date of birth and Social Security Number (for identity
                      verification)
                    </li>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                      Provide personalized financial planning and investment
                      advice
                    </li>
                    <li>Analyze your financial situation and risk tolerance</li>
                    <li>
                      Generate investment recommendations and portfolio
                      allocations
                    </li>
                ...
                <section>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-wealth-green-light p-4 rounded-lg">
                      <h4 className="font-semibold text-wealth-green mb-2">
                        Access Rights
                      </h4>
                      <p className="text-sm">
                ...
                <section>
                  ...
                  <p>
                    ...
                    to provide our Service and comply with legal obligations.
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    ...
                    <li>
                      Financial data: Retained for 7 years after account closure
                      (regulatory requirement)
                    </li>
                    <li>
                      Transaction records: Retained for 5 years after completion
                    </li>
                ...
                <section>
                  ...
                  <p>
                    Our Service is not intended for individuals under 18 years
                ...
                <section>
                  ...
                  <div className="bg-wealth-blue-light p-4 rounded-lg">
                    <ul className="space-y-2">
                      <li>
                        <strong>Privacy Officer:</strong> privacy@wealthapp.com
                      </li>
                      <li>
                        <strong>General Contact:</strong> support@wealthapp.com
                      </li>
                      <li>
