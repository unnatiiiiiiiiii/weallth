          ...
          <Card>
            ...
            <CardContent className="prose prose-lg max-w-none">
              <div className="space-y-8">
                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-wealth-blue">
                    1. Acceptance of Terms
                  </h2>
                  <p>
                    By accessing and using this wealth management and financial
                    planning application ("Service"), you accept and agree to be
                  ...
                  <p>
                    ...
                    you and our company. Your use of the Service is also
                    governed by our Privacy Policy, which is incorporated by
                ...
                <section>
                  ...
                  <p>
                    Our application provides comprehensive financial planning
                    tools, investment guidance, goal tracking, and wealth
                  ...
                  <p>
                    <strong>Important:</strong> The information provided is for
                    educational and planning purposes only and should not be
                    considered as professional financial advice, investment
                ...
                <section>
                  ...
                  <p>
                    You agree to use the Service responsibly and lawfully. You
                    shall not:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                ...
                <section>
                  ...
                  <p>
                    ...
                    information. Your data will be collected, used, and
                    protected in accordance with our Privacy Policy and
                    applicable data protection regulations including GDPR and
                    CCPA.
                  </p>
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    ...
                    <li>
                      Your right to access, modify, or delete your personal data
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  <h2 className="text-2xl font-semibold mb-4 text-wealth-blue">
                    6. Investment Disclaimers and Risk Warnings
                  </h2>
                  ...
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                      All investments carry risk, including potential loss of
                      principal
                    </li>
                    <li>Past performance does not guarantee future results</li>
                    <li>
                      Market values fluctuate and investments may be worth more
                      or less than originally invested
                    </li>
                    <li>
                      Our recommendations are based on general market analysis
                    ...
                    <li>
                      We do not provide personalized investment advice or act as
                      a fiduciary
                    </li>
                    <li>
                      Diversification does not guarantee protection against
                      market losses
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Our Service may offer both free and premium features.
                    Premium features require a subscription, billed according to
                    the plan you select:
                  </p>
                  <ul className="list-disc pl-6 space-y-2 mb-4">
                    <li>
                    ...
                    <li>
                      Upon cancellation, you retain access to premium features
                ...
                <section>
                  ...
                  <p>
                    ...
                    derivative works of our content without our explicit written
                    permission.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, OUR LIABILITY FOR
                    ANY CLAIMS RELATED TO THE SERVICE SHALL NOT EXCEED THE
                    AMOUNT YOU PAID US IN THE 12 MONTHS PRECEDING THE CLAIM.
                  </p>
                  <p>
                    WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
                    SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT
                    NOT LIMITED TO INVESTMENT LOSSES, DATA LOSS, OR BUSINESS
                    INTERRUPTION.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Our Service may integrate with third-party services, APIs,
                    or display content from external sources. We are not
                    responsible for the availability, accuracy, or reliability
                ...
                <section>
                  ...
                  <p>
                    ...
                    uninterrupted access to the Service. We may temporarily
                ...
                <section>
                  ...
                  <p>
                    ...
                    Service immediately, without prior notice, if you breach
                ...
                <section>
                  ...
                  <p>
                    ...
                    these Terms or your use of the Service will be resolved
                ...
                <section>
                  ...
                  <div className="bg-wealth-blue-light p-4 rounded-lg">
                    <ul className="space-y-2">
                      <li>
                        <strong>Email:</strong> legal@wealthapp.com
                      </li>
                      <li>
                        <strong>Phone:</strong> 1-800-WEALTH (1-800-932-5844)
                      </li>
                      <li>
                        <strong>Address:</strong> 123 Financial District, Suite
                        456, New York, NY 10004
                      </li>
                      <li>
