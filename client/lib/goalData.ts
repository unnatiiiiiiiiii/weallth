  ...
  try {
    if (goalType === "personal") {
      return [
        ...
        {
          name: "Big Event or Celebration",
          icon: "gift",
          bgColor: "bg-rose-100",
          iconColor: "text-rose-600",
        },
        {
          name: "Child's Education or Marriage",
          icon: "graduation-cap",
          bgColor: "bg-cyan-100",
        ...
        {
          name: "Healthcare / Life Insurance",
          icon: "activity",
          bgColor: "bg-red-100",
          iconColor: "text-red-600",
        },
