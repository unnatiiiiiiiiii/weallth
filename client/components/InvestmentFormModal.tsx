...
export default function InvestmentFormModal({
  ...
  const isAmountValid = strategy
    ? formData.amount >= strategy.minInvestment
    : false;
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="py-4">
            <p className="text-gray-600">
              No investment strategy selected. Please go back and select a
              strategy.
            </p>
          </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      goalId: value === "none" ? undefined : value,
                    }))
                  }
                >
                  <SelectTrigger>
          ...
          {formData.amount > 0 && isAmountValid && (
            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
              ...
              <p className="text-xs text-green-700 mt-2">
                *Returns are indicative and subject to market risks. Past
